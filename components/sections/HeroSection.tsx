...
import deepak from "@/public/Deepak-illustration.webp";
...
const HeroSection: React.FC = () => {
  ...
  <p>
    I am a Full-Stack Developer skilled in Next.js, TypeScript, and Prisma for web development, with expertise in SQL, Node.js, and Express on the backend. I have a strong foundation in C/C++, OOP, and software principles, utilizing Postman for API testing and optimization.
  </p>
</div>
